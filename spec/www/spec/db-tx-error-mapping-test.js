  ...
  for (var i=0; i<scenarioCount; ++i) {
    ...
    describe(scenarioList[i] + ': db tx error mapping test(s)' +
      ...
      var openDatabase = function(name, ignored1, ignored2, ignored3) {
        ...
        it(suiteName + 'syntax error: command with misspelling [XXX CHECK ERROR DETAILS on Android ref: litehelpers/Cordova-sqlite-evcore-extbuild-free#40]', function(done) {
          ...
          db.transaction(function(tx) {
            ...
            tx.executeSql('SLCT 1 ', [], function(tx) {
              ...
              if (isWebSql && !(/Android 4.[1-3]/.test(navigator.userAgent)))
                ...
                // XXX CHECK ERROR DETAILS Android (Android-evcore-native-driver) ref: litehelpers/Cordova-sqlite-evcore-extbuild-free#40
        ...
        it(suiteName + 'INSERT with VALUES in the wrong place (with a trailing space) [XXX TBD "incomplete input" vs "syntax error" message on (WebKit) Web SQL on Android 8.x/...; XXX TBD CHECK ERROR DETAILS on Android ref: litehelpers/Cordova-sqlite-evcore-extbuild-free#40]', function(done) {
          ...
          db.transaction(function(tx) {
            ...
            tx.executeSql('INSERT INTO test_table (data) VALUES ', [123], function(tx) {
              ...
              if (isWebSql && (/Android [7-9]/.test(navigator.userAgent)))
                ...
                expect(error.message).toMatch(/syntax error or other error.*code: 1 message: incomplete input/); // XXX CHECK ERROR DETAILS Android (Android-evcore-native-driver) ref: litehelpers/Cordova-sqlite-evcore-extbuild-free#40
              else if (isAndroid && isImpl2)
            ...
            if (isWebSql)
              ...
              // XXX TBD CHECK ERROR DETAILS Android (Android-evcore-native-driver) ref: litehelpers/Cordova-sqlite-evcore-extbuild-free#40
        ...
        it(suiteName + 'SELECT uper("Test") (misspelled function name) [XXX CHECK ERROR DETAILS on Android ref: litehelpers/Cordova-sqlite-evcore-extbuild-free#40; INCORRECT error code WebKit Web SQL & plugin]', function(done) {
        ...
        it(suiteName + 'SELECT FROM bogus table (other database error) [XXX CHECK ERROR DETAILS on Android ref: litehelpers/Cordova-sqlite-evcore-extbuild-free#40; INCORRECT error code WebKit Web SQL & plugin]', function(done) {
        ...
        it(suiteName + 'INSERT missing column [XXX TBD CHECK ERROR DETAILS on Android ref: litehelpers/Cordova-sqlite-evcore-extbuild-free#40; INCORRECT error code WebKit Web SQL & plugin]', function(done) {
          ...
          db.transaction(function(tx) {
            ...
            tx.executeSql('INSERT INTO test_table VALUES (?)', ['abcdef'], function(tx) {
              ...
              if (isWebSql && !(/Android 4.[1-3]/.test(navigator.userAgent)))
                ...
                expect(error.message).toMatch(/syntax error or other error.*code: 1 message: table test_table has 2 columns but 1 values were supplied/);
              else if (!isWebSql && !isWindows && isAndroid && isImpl2)
        ...
        it(suiteName + 'INSERT wrong column name [XXX TBD CHECK ERROR DETAILS on Android ref: litehelpers/Cordova-sqlite-evcore-extbuild-free#40; INCORRECT error code WebKit Web SQL & plugin]', function(done) {
        ...
        it(suiteName + 'CREATE VIRTUAL TABLE USING bogus module (other database error) [XXX TBD CHECK ERROR DETAILS on Android ref: litehelpers/Cordova-sqlite-evcore-extbuild-free#40; INCORRECT error code WebKit Web SQL & plugin]', function(done) {
        ...
        it(suiteName + 'transaction.executeSql syntax error (command with misspelling) with no SQL error handler [XXX TBD CHECK ERROR DETAILS on Android ref: litehelpers/Cordova-sqlite-evcore-extbuild-free#40]', function(done) {
